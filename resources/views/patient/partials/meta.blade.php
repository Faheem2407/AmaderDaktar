        ...
        <!-- Theme Settings Js -->
        <script src="{{ asset('main_assets/js/theme-script.js') }}"></script>
        ...
        <!-- Datepicker CSS -->
        <link rel="stylesheet" href="{{ asset('main_assets/css/bootstrap-datetimepicker.min.css') }}">

        <!-- Apex Css -->
        <link rel="stylesheet" href="{{ asset('main_assets/plugins/apex/apexcharts.css') }}">

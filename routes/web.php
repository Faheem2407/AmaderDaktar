...
Route::prefix('admin')->middleware(['auth', 'admin.access:dashboard'])->group(function () {
    Route::get('/dashboard', [AuthController::class, 'dashboard'])->name('admin.dashboard');
});

// Admin Profiles - requires admins.view permission
Route::prefix('admin')->middleware(['auth', 'admin.access:admins.view'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:doctors.view'])->group(function () {
    Route::get('doctors', [DoctorController::class, 'index'])->name('admin.doctors.index');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:doctors.create'])->group(function () {
    Route::post('doctors', [DoctorController::class, 'store'])->name('admin.doctors.store');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:doctors.edit'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:doctors.delete'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:patients.view'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:specialities.view'])->group(function () {
    Route::get('/specialities', [SpecialityController::class, 'index'])->name('admin.specialities.index');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:specialities.create'])->group(function () {
    Route::post('/specialities', [SpecialityController::class, 'store'])->name('admin.specialities.store');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:specialities.edit'])->group(function () {
    Route::put('/specialities/{speciality}', [SpecialityController::class, 'update'])->name('admin.specialities.update');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:specialities.delete'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:settings.view'])->group(function () {
    Route::get('/settings', [SettingController::class, 'index'])->name('admin.settings.index');
});

Route::prefix('admin')->middleware(['auth', 'admin.access:settings.edit'])->group(function () {
...
Route::prefix('admin')->middleware(['auth', 'admin.access:privileges.edit'])->group(function () {
